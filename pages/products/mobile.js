...
export default function Mobile() {
  ...
  return (
    <>
      <header className="w-full h-16 bg-indigo-600 drop-shadow-lg">
        <div className="container px-4 md:px-0 h-full mx-auto flex justify-between items-center">
          ...
          <ul
            id="menu"
            className={clsx(
              'fixed top-0 right-0 px-10 py-16 bg-gray-800 z-50 md:relative md:flex md:p-0 md:bg-transparent md:flex-row md:space-x-6',
      ...
      <main>
        <h1 className="mt-40 text-4xl text-center">Text</h1>
        <h2 className="mt-10 text-xl text-center">Text </h2>
      </main>
    </>
  );
}
